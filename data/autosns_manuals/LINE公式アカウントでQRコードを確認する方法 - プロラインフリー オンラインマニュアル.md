# LINE公式アカウントでQRコードを確認する方法 - プロラインフリー オンラインマニュアル

Source: https://autosns.co.jp/manual/application/line-official/qrcode
...
![LINE公式アカウントでQRコードを確認する方法](https://autosns.co.jp/manual/wp-content/uploads/2020/08/eye_qecode_1200×630.png)

[このページを印刷](javascript:void(0))

LINE公式アカウントで、自分のQRコードを確認する方法です。
...
![LINE公式アカウント アカウントリスト](https://autosns.jp/manual/wp-content/uploads/2020/08/img_account_list.png)
